...
public static class MailboxMessages
{
    ...
    public static string AccountNotFound(string aliasOrRef) =>
        $"No connected mailbox found for '{aliasOrRef}'. Use an account alias, mailbox:alias, or the account email. Check Workspace → Email accounts, or omit mailbox_alias to use the default account.";
